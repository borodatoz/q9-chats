export const WEB_CHAT_COPY = {
    ru: {
        ...
        unreadAria: (count) => count > 9 ? "9+ непрочитанных сообщений" : `${count} непрочитанных`,
    },
    en: {
        launcher: "Chat",
        close: "Close",
        ...
        faqTitle: "FAQ",
        unreadAria: (count) => count > 9 ? "9+ unread messages" : `${count} unread messages`,
    },
};
export function resolveWebChatCopy(locale) {
