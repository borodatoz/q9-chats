...
import { getOrCreateVisitorId, WebChatClient, } from "@q9/chats-core";
...
export function Q9ChatWidget({ apiBase, title = "Support", welcomeMessage, primaryColor, locale = "ru", pollIntervalMs = 4000, statusPollIntervalMs = 2500, showPreChatForm = false, faqItems = [], forceOffline = false, }) {
    ...
    const handlePreChat = async (event) => {
    ...
    return (_jsxs("div", { className: "q9-chat-widget", style: style, children: [_jsxs("button", { type: "button", className: "q9-chat-widget__launcher", "aria-label": badgeLabel ? t.unreadAria(unreadCount) : t.launcher, onClick: () => (open ? handleClose() : void handleOpen()), children: [_jsx("span", { className: "q9-chat-widget__launcher-icon", "aria-hidden": true, children: "\uD83D\uDCAC" }), badgeLabel ? (_jsx("span", { className: "q9-chat-widget__badge", children: badgeLabel })) : null] }), open ? (_jsxs("div", { className: "q9-chat-widget__panel", role: "dialog", "aria-label": title, children: [_jsxs("div", { className: "q9-chat-widget__header", children: [_jsx("span", { className: "q9-chat-widget__header-title", children: title }), _jsx("button", { type: "button", className: "q9-chat-widget__close", "aria-label": t.close, onClick: handleClose, children: "\u00D7" })] }), !preChatDone ? (_jsxs("form", { className: "q9-chat-widget__prechat", onSubmit: (e) => void handlePreChat(e), children: [_jsx("strong", { children: t.prechatTitle }), _jsxs("label", { className: "q9-chat-widget__field", children: [t.name, _jsx("input", { value: preChatName, onChange: (e) => setPreChatName(e.target.value), autoComplete: "name" })] }), _jsxs("label", { className: "q9-chat-widget__field", children: [t.phone, _jsx("input", { value: preChatPhone, onChange: (e) => setPreChatPhone(e.target.value), autoComplete: "tel" })] }), _jsx("button", { type: "submit", className: "q9-chat-widget__send", children: t.start })] })) : (_jsxs(_Fragment, { children: [loading ? (_jsx("div", { className: "q9-chat-widget__status", children: t.loading })) : null, !operatorsOnline ? (_jsxs("div", { className: "q9-chat-widget__offline", children: [_jsx("strong", { children: t.offlineTitle }), _jsx("p", { children: t.offlineHint }), faqItems.length > 0 ? (_jsxs("div", { className: "q9-chat-widget__faq", children: [_jsx("div", { className: "q9-chat-widget__faq-title", children: t.faqTitle }), faqItems.map((item, index) => (_jsxs("div", { className: "q9-chat-widget__faq-item", children: [_jsx("button", { type: "button", className: "q9-chat-widget__faq-q", "aria-expanded": expandedFaq === index, onClick: () => setExpandedFaq((prev) => prev === index ? null : index), children: item.question }), expandedFaq === index ? (_jsx("div", { className: "q9-chat-widget__faq-a", children: item.answer })) : null] }, item.question)))] })) : null, offlineSent ? (_jsx("div", { className: "q9-chat-widget__status", children: t.offlineSent })) : (_jsxs("form", { className: "q9-chat-widget__offline-form", onSubmit: (e) => void handleOfflineSubmit(e), children: [_jsxs("label", { className: "q9-chat-widget__field", children: [t.name, _jsx("input", { value: offlineName, onChange: (e) => setOfflineName(e.target.value), autoComplete: "name" })] }), _jsxs("label", { className: "q9-chat-widget__field", children: [t.email, _jsx("input", { type: "email", value: offlineEmail, onChange: (e) => setOfflineEmail(e.target.value), autoComplete: "email" })] }), _jsxs("label", { className: "q9-chat-widget__field", children: [t.phone, _jsx("input", { value: offlinePhone, onChange: (e) => setOfflinePhone(e.target.value), autoComplete: "tel" })] }), _jsxs("label", { className: "q9-chat-widget__field", children: [t.offlineMessageLabel, _jsx("textarea", { className: "q9-chat-widget__input", value: offlineText, onChange: (e) => setOfflineText(e.target.value), rows: 3, required: true })] }), _jsx("button", { type: "submit", className: "q9-chat-widget__send", children: t.offlineSubmit })] }))] })) : (_jsxs(_Fragment, { children: [_jsxs("div", { className: "q9-chat-widget__messages", children: [welcomeMessage ? (_jsx("div", { className: "q9-chat-widget__welcome", children: welcomeMessage })) : null, messages.map((message) => (_jsx("div", { className: isMine(message, session)
